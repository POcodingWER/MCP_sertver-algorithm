...
describe("DoublyLinkedList", () => {
  ...
  it("리스트에 객체를 저장하고 출력할 수 있어야 합니다", () => {
  ...
  it("커스텀 비교 함수를 통해 노드를 찾아야 합니다", () => {
    type CustomType = { value: number; customValue: string };
    ...
    const linkedList = new DoublyLinkedList<CustomType>(comparatorFunction);
